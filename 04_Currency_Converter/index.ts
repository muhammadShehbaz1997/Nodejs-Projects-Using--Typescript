...
if(from && to && Amount){  let result  = Converter[from][to] * Amount;
console.log(chalk.green(`Your Conversation from ${from} to ${to} is ${result}`));   }

      else { console.log(chalk.red(`Invalid Inputs`)); }
